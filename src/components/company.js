    ...
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <header className="mx-auto max-w-2xl lg:mx-0 text-center">
          <h2 className="text-5xl font-semibold tracking-tight text-white sm:text-7xl">Innovation meets creativity</h2>
        ...
        {/* Company Statistics */}
        <div className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4 text-white">
        ...
        <section className="mt-16">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-gray-800 p-4 rounded-lg text-center">
              <h4 className="text-xl font-semibold text-white">Alice Johnson</h4>
              <p className="text-gray-300">CEO & Founder</p>
            </div>
            {/* Team Member 2 */}
            <div className="bg-gray-800 p-4 rounded-lg text-center">
              <h4 className="text-xl font-semibold text-white">Bob Smith</h4>
              <p className="text-gray-300">Lead Developer</p>
            </div>
            {/* Team Member 3 */}
            <div className="bg-gray-800 p-4 rounded-lg text-center">
              <h4 className="text-xl font-semibold text-white">Clara Lee</h4>
              <p className="text-gray-300">UI/UX Designer</p>
            </div>
            {/* Team Member 4 */}
            <div className="bg-gray-800 p-4 rounded-lg text-center">
              <h4 className="text-xl font-semibold text-white">David Brown</h4>
              <p className="text-gray-300">Marketing Specialist</p>
            </div>
            {/* Team Member 5 */}
            <div className="bg-gray-800 p-4 rounded-lg text-center">
              <h4 className="text-xl font-semibold text-white">Eva Green</h4>
